...
<section data-slice-type={slice.slice_type} data-slice-variation={slice.variation} class ="px-4 md:px-6">
	...
	<span class = "block text-stone-400">
		{slice.primary.first_name}
	</span>
	<span class = "block text-stone-700 -mt-[.1em]">
	{slice.primary.last_name}
	</span>
	</h1>
	

	<span class = "block bg-gradient-to-tr from-emerald-500 via-emerald-300 to-emerald-500 bg-clip-text text-transparent text-2xl font-bold uppercase tracking- [.2em] md:text-4xl">
